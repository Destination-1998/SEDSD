...
from utils import ramps, losses, test_patch_leafspot, feature_memory, correlation
...
parser.add_argument('--dataset_name', type=str, default='zaoyibing', help='dataset_name')
parser.add_argument('--root_path', type=str, default='/home/felicia/datasets/leaf_spots/', help='Name of Dataset')
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            for i in range(num_outputs):
                ...
                loss_s += dice_loss(y,label_batch[:labeled_bs,...])
            ...
            iter_num = iter_num + 1
            lambda_c = get_lambda_c(iter_num // 500)
            lambda_o = get_lambda_o(iter_num // 500)
