...
from dataloaders.Kvasir_SEG_Dataset import Kvasir_SEG
from networks_2d.net_factory_2d import net_factory
...
parser.add_argument('--dataset_name', type=str, default='Kvasir_SEG', help='dataset_name')
...
parser.add_argument('--max_samples', type=int, default=700, help='maximum samples to train')
...
parser.add_argument('--labelnum', type=int, default=70, help='trained samples')
...
if args.dataset_name == "zaoyibing":
    ...
    args.max_samples = 800
train_data_path = args.root_path


if args.dataset_name == "Kvasir_SEG":
    patch_size = (512,512)
    args.root_path = args.root_path + args.dataset_name
    args.max_samples = 700
train_data_path = args.root_path
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            for i in range(num_outputs):
                ...
                loss_s += dice_loss(y[:, 1, ...],label_batch[:labeled_bs,...])
            ...
            for i in range(args.labeled_bs):
                ...
                labeled_features_correct_list.append((proj_labeled_features_v[i][mask_prediction_correctly[i,0, ...]] +
                                                      proj_labeled_features_a[i][mask_prediction_correctly[i,0, ...]]) / 2)
            ...
            unlabeled_features_v = unlabeled_features_v.permute(0, 2, 3, 1)
            unlabeled_features_a = unlabeled_features_a.permute(0, 2, 3, 1)
            ...
            if iter_num >= 800 and iter_num % 200 == 0:
                ...
                if args.dataset_name == "Kvasir_SEG":
                    dice_sample = test_patch_leafspot.var_all_case(model, num_classes=num_classes, patch_size=patch_size,
                                                                   stride_xy=18, stride_z=4, dataset_name='Kvasir_SEG')
